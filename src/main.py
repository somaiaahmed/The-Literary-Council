...
# ─── Gemini helper ────────────────────────────
async def ask_gemini(system_prompt: str, user_prompt: str, model: str = "gemini-3-flash-preview") -> str:
...
"""
        ...
        synthesis = await ask_gemini(synthesis_system, synthesis_prompt, model="gemini-3-flash-preview")
